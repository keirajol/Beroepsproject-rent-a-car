        ...
        <div class="auto">
            ...
            <div class="row-1">
                <div class="auto-blokken">
                    <div class="toevoegen">
                      <a href="../auto-wijzigen/auto-wijzigen.html"> <button class="toevoegen"><img src="../IMG/plus (2).png" alt="toevoegen" id="plus"><button></a>
               </div>
               </div>
            ...
            <div class="car-1">
                ...
                <a href=".."><button class="wijzig-button"><img src="../IMG/wijzig.png" alt="wijzig" class="wijzig"></button></a> 
                <a href=".."><button class="prullebak-button"><img src="../IMG/prullebak.png" alt="verwijder" class="prullebak"></button></a>
            </div>
            </div>

            <div class="auto-blokken">
            <div class="car-2">
                <h2>2021 Ferrari F8 spider</h2>
            ...
            <div class="auto-blokken">
                ...
                <div class="auto-blokken">
                <div class="car-9">
                    <h2>2021 Dodge Charger Hellcat</h2>
